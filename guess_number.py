...
if debug_cheat == 1:
    ...
    print('Идентификатор debug_cheat определен неверно!\nПожалуйста остановите выполение кода для предотвращения непредвиденных ошибок\nИГРА СОХРАНЕНА НЕ БУДЕТ!!!\nПоставьте 0 или 1 в 85 строчке чтобы выключить/включить debug_cheat')
# *DEBUG CODE END
...
if debug_cheat == 2:
    ...
    print('\nError\nError\nИгра не может быть сохранена в связи с неизвестным идентификатором debug_cheat\nИзмените идентификатор!\nError\nError\n\n')
    file.write('\nFATAL ERROR Данные игры: не определено\nИдентификатор debug_cheat не соответствует допущенным!\nFATAL ERROR')
file.close()    